...
export default function SmallBus() {
	...
	<div class="kw-transfer-card__class">
		<div class="kw-transfer-card__class-inner">
			<header style={{color:'Black'}} class="kw-transfer-card__class-title">Small Bus</header>
			<div class="kw-transfer-card__picture-wrapper">
				<picture class="transfer__preview__pic">
					<source srcset="https://fscdn.kiwitaxi.com/assets/images/vehicles/11.webp 1x, https://fscdn.kiwitaxi.com/assets/images/vehicles/11.webp 2x" type="image/webp"></source>
					<source srcset="https://fscdn.kiwitaxi.com/assets/images/vehicles/11.webp 1x, https://fscdn.kiwitaxi.com/assets/images/vehicles/1@2x.png 2x" type="image/png"></source>
					<img src="https://fscdn.kiwitaxi.com/assets/images/vehicles/11.webp" alt="Economy"></img>
				</picture>
			</div>
	...
	<div class="kw-transfer-card__description">
		<header class="kw-transfer-card__description-title">Small Bus</header>
...
<span class="kw-flex-align-center"></span>
			<img class="kw-icon" alt="Pax" src="https://fscdn.kiwitaxi.com/assets/images/static/icons/pax.svg"></img><span>15</span>
...
<img class="kw-icon" alt="Baggage" src="https://fscdn.kiwitaxi.com/assets/images/static/icons/baggage.svg"></img><span>15</span>
			</span>
		</div>
